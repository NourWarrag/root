...
{
    public partial class MThrmsonboarding
    {
        public long MThrmsonboardingId { get; set; }
        ...
        public long? CandidateEntryId { get; set; }
        public DateTime? OnboardingDate { get; set; }
        public string Status { get; set; }

        public MThrmscvrepository Candidate { get; set; }
        public MThrmscandidateEntry CandidateEntry { get; set; }
